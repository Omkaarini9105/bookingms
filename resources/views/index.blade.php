                ...
                <div class="collapse navbar-collapse" id="navbar1">
                    <div class="navbar-nav mx-auto text-black">
                        ...
                        <a href="#" class="navbar-brand d-none d-md-block">
                            <img src="{{ asset('assets/images/image.png') }}" alt="Brand Logo">
                        </a>

                        <a href="{{ url('page/about-us') }}" class="nav-item nav-link text-black">About Us</a>
        ...
        <div id="carousel" class="carousel slide" data-bs-ride="carousel">
            ...
            <div class="carousel-inner">
                <div class="carousel-item active">
                    <img src="{{ asset('assets/images/banner1.png') }}" class="d-block w-100" alt="Banner 1">
                </div>
    ...
    <main class="m-5">
        <section class="container m-4" id="about-us">
            ...
            <div class="row">
                <div class="col-md-5">
                    <div class="container">
                        <img src="{{ asset('assets/images/about.png') }}" class="d-block w-100" alt="About Us">
                    </div>
                </div>
                <div class="col-md-7">
     ...
     src="{{ asset('assets/images/team3.jpg') }}"
     alt="Guest Relations Officer"
     style="height:300px; object-fit:cover;">
                            <div class="card-body text-center">
                                <h4 class="card-title">Team Member 1</h4>
                                <p class="card-text">Aakrsha Bandi,CEO of Resort </p>
                    ...
                    <div class="col-md-4 d-flex align-items-center justify-content-center">
                        <div class="card" style="width: 300px;">
                           <img class="card-img-top"
     src="{{ asset('assets/images/team1.jpeg') }}"
     alt="Hotel Manager"
     style="height:300px; object-fit:cover;">
                            <div class="card-body text-center">
                                <h4 class="card-title">Team Member 2</h4>
                                <p class="card-text">Omkaarini Annapuri, FOUNDER of Resort. </p>
                                <i class="bi bi-facebook icon-sm m-2"></i>
                                <i class="bi bi-instagram icon-sm m-2"></i>
                                <i class="bi bi-linkedin icon-sm m-2"></i>
                            </div>
                    ...
                    <div class="col-md-4 d-flex align-items-center justify-content-center">
                        <div class="card" style="width: 300px;">
                            <img class="card-img-top"
     src="{{ asset('assets/images/team2.jpeg') }}"
     alt="Front Desk Executive"
     style="height:300px; object-fit:cover;">
                            <div class="card-body text-center">
                                <h4 class="card-title">Team Member 3</h4>
                                <p class="card-text">Amgothu Amogha Naik ,DIRECTOR of Resort </p>
                                <i class="bi bi-facebook icon-sm m-2"></i>
                                <i class="bi bi-instagram icon-sm m-2"></i>
                                <i class="bi bi-linkedin icon-sm m-2"></i>
                            </div>
            ...
            <div class="row">
                <div class="col-md-6">
                    <div class="container m-5">
                        <img src="assets/image.png" height="30px" class="bg-white">
                        <div>
